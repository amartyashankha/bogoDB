...
from scripts.constants import MAX_EDGES_PER_NODE, MAX_TOTAL_EDGES, NUM_NODES
...
def validate_graph(
    ...
    print("✅ All edge weights are within valid range (0-10)")
...
def compare_results(
    ...
    print("  Higher is better, rewards both success and shorter paths")
