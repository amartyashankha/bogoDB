...
from scripts.constants import DATA_DIR, INITIAL_RESULTS_FILE, NUM_NODES, QUERIES_FILE
...
def visualize_query_distribution(queries_file=QUERIES_FILE):
    ...
    # Save visualization
    output_file = os.path.join(DATA_DIR, "query_distribution.png")
    ...
    # Save visualization
    output_file = os.path.join(DATA_DIR, "query_frequency.png")
    plt.savefig(output_file)
...
def visualize_path_distribution(results_file=INITIAL_RESULTS_FILE):
    ...
    # Save visualization
    output_file = os.path.join(DATA_DIR, "path_distribution.png")
    plt.savefig(output_file)
